...
import com.anshu.dynamicnotes.ui.Constants
...
class FolderBottomSheet : BottomSheetDialogFragment() {
        ...
        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
            val view: View = inflater.inflate(R.layout.bottom_folder_sheet, container, false)
            val rename: ConstraintLayout = view.findViewById(R.id.rename)
...
//        }
        ...
        private fun handleArguments() {
            ...
            tvName!!.text = name//            name = bundle!!.getString(Constants.NAME)
...
//            fun onFolderLockClicked()
        ...
        companion object {
            fun newInstance(name: String): FolderBottomSheet {
                val args = Bundle()
...
//                args.putString(Constants.DOCUMENT_NAME, displayName)
                val fragment = FolderBottomSheet()
